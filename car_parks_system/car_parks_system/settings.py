"""
Django settings for car_parks_system project.
...
SECRET_KEY = "django-insecure-uax808w6grswysj!ebr4c4sl+o#rzh8^&x1jni(p(4%y6cfn4^"
...
WSGI_APPLICATION = "car_parks_system.wsgi.application"
